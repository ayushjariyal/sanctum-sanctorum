...
class Loan(Base):
    ...
    # Stored rather than derived from borrowed_at: changing the loan period later
    # must not silently move the due date of loans already out.
    due_at: Mapped[datetime] = mapped_column(DateTime)
    # Null until the book comes back; this is what makes a loan "unreturned".
